...
// import PineconeClient, { embeddingsInstance } from "@/lib/pinecone";
...
import { embeddingsInstance, PineconeClient } from "./pinecone";
...
export async function generateEmbeddingsInPineStore(docName, docId) {
	...
	if (nameSpaceAlreadyExists) {
		...
		vectorStore = await PineconeStore.fromExistingIndex(embeddingsInstance, {
